...
namespace doanasp.Areas.Admin.Controllers
{
    ...
    public class InvoiceDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,InvoiceId,ProductId,Quantity,UnitPrice,Discount,Createddate")] InvoiceDetail invoiceDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,InvoiceId,ProductId,Quantity,UnitPrice,Discount,Createddate")] InvoiceDetail invoiceDetail)
        {
